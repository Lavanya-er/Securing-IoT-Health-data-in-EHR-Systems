function varargout = MHR(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @MHR_OpeningFcn, ...
                   'gui_OutputFcn',  @MHR_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% varargin   command line arguments to MHR (see VARARGIN)

% Choose default command line output for MHR
...
% UIWAIT makes MHR wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = MHR_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global arduino;global tf1;
if(tf1==1)
arduino=serial('COM3','BaudRate',9600);
fopen(arduino);
y=fscanf(arduino,'%s');
set(handles.edit15,'String','ID Received');
set(handles.edit14,'String',y);
fclose(arduino);
s2 = '83D461FC';
val = strcmp(y,s2);
...
if(val==1)
    run('MongoTesttt.p');
    set(handles.edit15,'String','Data Retrived');
javaaddpath('iText-4.2.0-com.itextpdf.jar')
pdf_text = pdfRead('update.pdf');
load('DATABASE_mhr.mat');pause(2);
run('DATABASE_call.p');
...
set(handles.edit11,'String','**');
set(handles.edit14,'String','**');
set(handles.edit15,'String','Wrong ID Detect');
 axes(handles.axes1); axis off    
end
else
 msgbox('Error');   
...
fclose(arduino);
set(handles.edit15,'String','Arduino Disconnected');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.edit13, 'Min', 0, 'Max', 2);
set(handles.edit13,'String','**');
set(handles.edit1,'String','**');
set(handles.edit4,'String','**');
set(handles.edit5,'String','**');
...
% handles    structure with handles and user data (see GUIDATA)
global tf1;
s1=get(handles.edit16,'String');
s2 = '123456';
tf1 = strcmp(s1,s2);
if(tf1==1)
msgbox('Welcome Alex');
else
    msgbox('You are not a valid Person');
end
